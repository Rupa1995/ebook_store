...
CREATE TABLE `address` (
  ...
  `auser_id` int(10) DEFAULT NULL,
  `aorder_id` int(10) NOT NULL DEFAULT '0',
  `street1` text,
  `street2` text,
  `astate_id` int(10) DEFAULT NULL,
  `acontry_id` int(10) DEFAULT NULL,
...
INSERT INTO `address` (`address_id`, `auser_id`, `aorder_id`, `street1`, `street2`, `astate_id`, `acontry_id`, `region`, `city`, `zip`) VALUES
(1, 2, 0, 'Banneghatta Road', 'JP Nagar', 17, 101, '3rd Phase', 'Bangalore', '560078'),
(2, 1, 0, 'Salt Lake', '', 41, 101, '', 'Kolkata', '700091'),
(3, 1, 0, 'AJ  - 109 Salt Lake', '', 41, 101, '', 'Kolkata', '700091');
...
INSERT INTO `author_table` (`author_id`, `author_name`, `author_isactive`) VALUES
(1, 'Harper Lee', 1),
(2, 'Gabriel Garcia Marquez', 1),
(3, 'Stephen King', 1),
(4, 'J. K. Rowling', 1),
(5, 'Ruskin Bond', 1),
(6, 'Chetan Bhagats', 1);
...
INSERT INTO `author_table_log` (`at_log_id`, `at_author_id`, `modified_by`, `modified_time`, `log_data`) VALUES
(1, 6, 1, '2018-05-06 19:57:39', '{"author_name":{"Chetan Bhagat":"Chetan Bhagats"}}'),
(2, 6, 1, '2018-05-06 20:00:56', '{"catStatus":{"Activate":"Deactivate"}}'),
(3, 6, 1, '2018-05-12 02:33:24', '{"catStatus":{"Deactivate":"Activate"}}');
...
INSERT INTO `book_cart` (`book_cart_id`, `bc_book_id`, `bc_user_id`, `bc_added_tym`) VALUES
(1, 1, 2, '2018-05-11 22:55:19'),
(2, 2, 2, '2018-05-12 00:07:38');
...
INSERT INTO `book_cat` (`cat_id`, `cat_name`, `cat_isactive`) VALUES
(1, 'Southern Gothic', 1),
(2, 'Magic realism', 1),
(3, 'Tragedy', 1),
(4, 'Tragic comedy', 1),
...
INSERT INTO `book_cat_log` (`bc_log_id`, `bc_cat_id`, `modified_by`, `modified_time`, `log_data`) VALUES
(1, 1, 1, '2018-05-06 18:16:11', '{"cat_name":{"Southern Gothi":"Southern Gothic"}}'),
(2, 1, 1, '2018-05-06 18:52:16', '{"catStatus":{"Deactivate":"Activate"}}'),
(3, 1, 1, '2018-05-06 18:54:11', '{"catStatus":{"Activate":"Deactivate"}}'),
(4, 1, 1, '2018-05-06 19:00:19', '{"catStatus":{"Deactivate":"Activate"}}');
...
CREATE TABLE `book_table` (
  ...
  `book_pubid` int(10) NOT NULL,
  `book_authid` int(10) NOT NULL,
  `book_cat_id` int(10) NOT NULL,
...
INSERT INTO `book_table` (`book_id`, `book_title`, `book_pubid`, `book_authid`, `book_cat_id`, `book_published_date`, `book_mrp`, `book_quantity`, `book_visitor`, `book_image`) VALUES
(1, 'To Kill a Mockingbird', 1, 1, 1, '2018-05-01', 45, 4, 0, '../images/book_img/220px-To_Kill_a_Mockingbird.JPG'),
(2, 'One Hundred Years of Solitude', 2, 2, 2, '2018-05-01', 797, 4, 0, '../images/book3.jpg'),
(3, 'Go Set a Watchman', 2, 1, 2, '2018-05-01', 786, 6, 0, '../images/book4.jpg'),
(4, 'Half Girlfriend', 5, 6, 5, '2018-05-11', 123, 2, 10, '../images/book_img/Half_Girlfriend.jpg');
...
INSERT INTO `book_table_log` (`bt_log_id`, `bt_book_id`, `modified_by`, `modified_time`, `log_data`) VALUES
(1, 1, 1, '2018-05-05 15:21:17', '{"quantity":{"3":"4"}}'),
(2, 2, 1, '2018-05-05 15:23:04', '{"quantity":{"2":"3"}}'),
(3, 2, 1, '2018-05-05 15:23:49', '{"quantity":{"3":"4"}}'),
(4, 1, 1, '2018-05-05 15:25:05', '{"quantity":{"4":"3"}}'),
(5, 3, 1, '2018-05-05 22:12:21', '{"book_mrp":{"78":"786"}}'),
(6, 1, 1, '2018-05-06 23:46:33', '{"book_published_date":{"2018-05-07":"2018-05-09"}}'),
(7, 1, 1, '2018-05-06 23:50:00', '{"book_published_date":{"2018-05-09":"2018-05-01"}}'),
(8, 1, 1, '2018-05-06 23:58:40', '{"book_published_date":{"2018-05-01":"2018-05-04"}}'),
(9, 1, 1, '2018-05-07 00:10:38', '{"book_published_date":{"2018-05-04":"2018-05-02"}}'),
(10, 1, 1, '2018-05-07 00:13:12', '{"book_published_date":{"2018-05-02":"2018-05-01"}}'),
(11, 1, 1, '2018-05-07 00:14:29', '{"book_published_date":{"2018-05-01":"2018-05-16"}}'),
(12, 1, 1, '2018-05-12 01:33:32', '{"book_quantity":{"3":"4"}}'),
(13, 1, 1, '2018-05-12 01:34:42', '{"book_quantity":{"3":"4"}}'),
(14, 1, 1, '2018-05-12 01:35:33', '{"book_quantity":{"3":"4"}}'),
(15, 1, 1, '2018-05-12 01:38:00', '{"book_published_date":{"2018-05-16":"2018-05-01"}}'),
(16, 3, 1, '2018-05-12 01:49:55', ''),
(17, 3, 1, '2018-05-12 01:51:04', ''),
(18, 3, 1, '2018-05-12 01:53:57', ''),
(19, 3, 1, '2018-05-12 01:54:30', ''),
(20, 3, 1, '2018-05-12 01:55:39', ''),
(21, 1, 1, '2018-05-12 02:23:26', ''),
(22, 1, 1, '2018-05-12 02:24:18', ''),
(23, 1, 1, '2018-05-12 02:24:42', ''),
(24, 2, 1, '2018-05-12 02:24:58', '');
...
INSERT INTO `book_wish` (`book_wish_id`, `bw_book_id`, `bw_user_id`, `bw_added_tym`) VALUES
(1, 3, 2, '2018-05-12 00:24:54');
...
INSERT INTO `item_table` (`item_id`, `item_book_id`, `item_name`, `item_price`, `item_order_id`) VALUES
(1, 4, 'Half Girlfriend', 123, 1),
(2, 5, '2 States', 0, 1),
(3, 4, 'Half Girlfriend', 123, 2),
(4, 5, '2 States', 0, 2),
(5, 4, 'Half Girlfriend', 123, 3),
(6, 5, '2 States', 0, 3),
(7, 4, 'Half Girlfriend', 123, 4),
(8, 5, '2 States', 0, 4),
(9, 4, 'Half Girlfriend', 123, 5),
(10, 5, '2 States', 0, 5),
(11, 4, 'Half Girlfriend', 123, 6),
(12, 5, '2 States', 0, 6),
(13, 4, 'Half Girlfriend', 123, 7),
(14, 5, '2 States', 0, 7),
(15, 4, 'Half Girlfriend', 123, 8),
(16, 5, '2 States', 0, 8),
(17, 4, 'Half Girlfriend', 123, 9),
(18, 5, '2 States', 0, 9),
(19, 4, 'Half Girlfriend', 123, 10),
(20, 5, '2 States', 0, 10),
(21, 4, 'Half Girlfriend', 123, 11),
(22, 5, '2 States', 0, 11),
(23, 4, 'Half Girlfriend', 123, 12),
(24, 5, '2 States', 0, 12),
(25, 4, 'Half Girlfriend', 123, 13),
(26, 5, '2 States', 0, 13),
(27, 4, 'Half Girlfriend', 123, 14),
(28, 5, '2 States', 0, 14);
...
INSERT INTO `order_table` (`order_id`, `payment_id`, `order_time`, `order_by`, `oder_amt`, `order_name`) VALUES
(1, 'PAY-3N751167UL976053TLL5RFOQ', '2018-05-15 17:03:35', 2, 126.69, 'Rupa Rani');
...
INSERT INTO `pub_info` (`pub_id`, `pub_name`, `pub_isactive`) VALUES
(1, 'J. B. Lippincott & Co.', 1),
(2, 'Harper & Row', 1),
(3, 'Jaico Publishing House', 1),
(4, 'Westland Publication', 1),
(5, 'Rupa & Co.', 1);
...
INSERT INTO `pub_table_log` (`pt_log_id`, `pt_pub_id`, `modified_by`, `modified_time`, `log_data`) VALUES
(1, 4, 1, '2018-05-06 21:08:23', '{"pub_name":{"Westland Publications":"Westland Publication"}}'),
(2, 4, 1, '2018-05-06 21:10:57', '{"catStatus":{"Activate":"Deactivate"}}'),
(3, 4, 1, '2018-05-06 21:11:15', '{"catStatus":{"Activate":"Deactivate"}}'),
(4, 4, 1, '2018-05-06 21:12:22', '{"catStatus":{"Activate":"Deactivate"}}'),
(5, 4, 1, '2018-05-06 21:27:58', '{"catStatus":{"Activate":"Deactivate"}}'),
(6, 4, 1, '2018-05-06 21:31:04', '{"catStatus":{"Deactivate":"Activate"}}');
...
INSERT INTO `user_log` (`user_log_id`, `modified_time`, `modified_by`, `log_data`, `luser_id`) VALUES
(1, '2018-04-29 23:23:15', '2', '{"area":{"3rd":"Bannerghatta Road"}}', '2'),
(2, '2018-04-30 22:54:29', '1', '{"userStatus":{"Activate":"Deactivate"}}', '2'),
(4, '2018-04-30 23:47:18', '1', '{"userStatus":{"Deactivate":"Activate"}}', '2'),
(5, '2018-05-01 23:04:36', '1', '{"street1":{"Salt Lake":"AJ  - 109 Salt Lake"}}', '1');
...
CREATE TABLE `user_table` (
  ...
  `user_isactive` int(11) DEFAULT '1',
  `user_admin_flag` int(11) DEFAULT '0',
...
INSERT INTO `user_table` (`user_id`, `user_name`, `user_password`, `user_isactive`, `user_admin_flag`, `user_mobile`, `user_fname`, `user_lname`, `first_tym_flag`) VALUES
(1, 'portaladmin@ebook.in', '202cb962ac59075b964b07152d234b70', 1, 1, 33445566, 'Portal', 'Admin', 2),
(2, 'riturajreso@gmail.com', '202cb962ac59075b964b07152d234b70', 1, 0, NULL, 'Ravi', 'Kumar', 1);
...
--
-- Indexes for table `author_table_log`
--
ALTER TABLE `author_table_log`
  ADD PRIMARY KEY (`at_log_id`);
...
--
-- Indexes for table `book_cat_log`
--
ALTER TABLE `book_cat_log`
  ADD PRIMARY KEY (`bc_log_id`);
...
--
-- Indexes for table `book_table_log`
--
ALTER TABLE `book_table_log`
  ADD PRIMARY KEY (`bt_log_id`);

--
-- Indexes for table `book_wish`
--
ALTER TABLE `book_wish`
  ADD PRIMARY KEY (`book_wish_id`);
...
--
-- Indexes for table `pub_info`
--
ALTER TABLE `pub_info`
  ADD PRIMARY KEY (`pub_id`);

--
-- Indexes for table `pub_table_log`
--
ALTER TABLE `pub_table_log`
  ADD PRIMARY KEY (`pt_log_id`);
...
--
-- AUTO_INCREMENT for table `author_table_log`
--
ALTER TABLE `author_table_log`
  MODIFY `at_log_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `book_cart`
--
ALTER TABLE `book_cart`
  MODIFY `book_cart_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
-- AUTO_INCREMENT for table `book_cat_log`
--
ALTER TABLE `book_cat_log`
  MODIFY `bc_log_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
...
--
-- AUTO_INCREMENT for table `book_table_log`
--
ALTER TABLE `book_table_log`
  MODIFY `bt_log_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
--
-- AUTO_INCREMENT for table `book_wish`
--
ALTER TABLE `book_wish`
  MODIFY `book_wish_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `item_table`
  MODIFY `item_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
--
...
--
-- AUTO_INCREMENT for table `pub_info`
--
ALTER TABLE `pub_info`
  MODIFY `pub_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `pub_table_log`
--
ALTER TABLE `pub_table_log`
  MODIFY `pt_log_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--

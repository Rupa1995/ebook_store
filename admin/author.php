            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="pull-right"> 
                 ...
                 <a href="#" id="create_author" class="btn btn-orange mar-bot-10" title ="" data-placement="left" data-toggle="tooltip" data-original-title = ""><span class="glyphicon glyphicon-plus-sign " aria-hidden="true"></span> Add Author</a></div>
              </div>
            </div>
              ...
              <table class="table table-hover table-bordered">                 
                <thead>
                  <tr>
                    ...
                    <th id="b_sort_bookcat" class="sort_book" width="10%">Author Name</th>
                    <th class="remove_sort" width="9%">Action</th>
                  </tr>
                </thead>
                <tbody id="authorListTBody"></tbody>
              </table>
            </div>
          </div>
...
<div class="modal fade form-modal" id="create_author_pop" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static">
	<div class="modal-dialog modal-sm" role="document">
		<div class="modal-content">
		    <div class="modal-header">
		      <button type="button" class="close page-scroll-set" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
		    ...
		    <div class="modal-body"> 
		       <div class="form-group">
		        <div class="row">
		          <div class="col-sm-12">
		            <div class="col-sm-12 col-md-12 col-lg-12 ">
		              <label id="create_label">Author Name <span class="red">*</span></label>
...
<div class="modal fade form-modal" id="edit_author_pop" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static">
	<div class="modal-dialog modal-sm" role="document">
		<div class="modal-content">
		    <div class="modal-header">
		      <button type="button" class="close page-scroll-set" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
		    ...
		    <div class="modal-body"> 
		       <div class="form-group">
		        <div class="row">
		          <div class="col-sm-12">
		            <div class="col-sm-12 col-md-12 col-lg-12 ">
		              <label id="edit_label">Author Name <span class="red">*</span></label>
    		...
    		<input type="hidden" name="old_auth_val" id="old_auth_val">
		</div>
	</div>
</div>
...
<script type='text/javascript' src="../javascripts/manage_author.js"></script>
